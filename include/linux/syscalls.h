...
/* kernel/mycall.c*/
asmlinkage long sys_retconst(void);
asmlinkage long sys_hello(void);
asmlinkage long sys_ptr5000(int __usr* val);
asmlinkage long sys_argptr(void __usr* ptr);
asmlinkage long sys_getstate(void);

/* kernel/sandbox.c*/
asmlinkage long sys_register_proc_with_sandbox(pid_t __user pid);
asmlinkage long sys_unregister_proc_with_sandbox(pid_t __user pid);
asmlinkage long sys_register_syscall_with_sandbox(int _user syscall);
asmlinkage long sys_unregister_syscall_with_sandbox(int _user syscall);
